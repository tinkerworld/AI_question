...
export async function runSeed() {
  ...
  const defaultProviders = [
    ...
    {
      id: 'prov_cloud_nvidia',
      name: 'NVIDIA Build Cloud (Nemotron / Llama 3.1 Authoring Scope)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_interview_cloud_nvidia',
      name: 'NVIDIA Build Cloud (Nemotron / Llama 3.1 Interview Scope)',
      type: 'CLOUD',
      modelId: 'nvidia/llama-3.1-nemotron-70b-instruct',
      baseUrl: 'https://integrate.api.nvidia.com/v1',
      priority: 1,
