...
export async function runSeed() {
  ...
  const defaultProviders = [
    // Scope 1: question_generation (Synthesis from blueprint / syllabus)
    {
      id: 'prov_qgen_cloud_groq',
    ...
    {
      id: 'prov_qgen_cloud_nvidia',
      name: 'NVIDIA Build Cloud (Nemotron 70B Generation)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qgen_cloud_gemini',
      name: 'Google Gemini Provider (Flash 1.5 Synthesis)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qgen_cloud_openrouter',
      name: 'OpenRouter Provider (Meta Llama 3.3 70B Free)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qgen_cloud_openai',
      name: 'OpenAI Cloud Provider (GPT-4o Mini)',
      type: 'CLOUD',
      modelId: 'gpt-4o-mini',
    ...
    {
      id: 'prov_qgen_mock_01',
      name: 'Deterministic Question Generator Mock Engine',
      type: 'MOCK',
      modelId: 'mock-qgen-v1',
      baseUrl: 'http://localhost:4043/internal/ai/mock-qgen',
      priority: 999,
      scope: 'question_generation',
      isActive: true,
    },

    // Scope 2: question_paraphrase (Fast rephrasing & modification)
    {
      id: 'prov_qpara_cloud_groq',
      name: 'Groq Cloud Instant Paraphraser (Llama 3.1 8B Instant)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qpara_cloud_nvidia',
      name: 'NVIDIA Build Cloud Fast (Llama 3.1 8B Instruct)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qpara_cloud_gemini',
      name: 'Google Gemini Provider (Flash 1.5 Paraphraser)',
      type: 'CLOUD',
      modelId: 'gemini-1.5-flash',
      baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
      priority: 2,
    ...
    {
      id: 'prov_qpara_cloud_openrouter',
      name: 'OpenRouter Fast (Llama 3.1 8B Free)',
      type: 'CLOUD',
    ...
    {
      id: 'prov_qpara_local_01',
      name: 'Local LLM Paraphraser (Ollama / LocalAI)',
      type: 'LOCAL',
      modelId: 'llama3:8b',
      baseUrl: 'http://localhost:11434',
      priority: 10,
    ...
    {
      id: 'prov_qpara_mock_01',
      name: 'Deterministic Question Paraphrase Mock Engine',
      type: 'MOCK',
      modelId: 'mock-qpara-v1',
      baseUrl: 'http://localhost:4043/internal/ai/mock-qpara',
      priority: 999,
      scope: 'question_paraphrase',
      isActive: true,
    },

    // Scope 3: interview_conversation (Live multi-turn low latency dialogue)
    {
      id: 'prov_ivconv_cloud_groq',
      name: 'Groq Cloud Ultra-Low Latency Conversationalist (Llama 3.3 70B)',
      type: 'CLOUD',
      modelId: 'llama-3.3-70b-versatile',
      baseUrl: 'https://api.groq.com/openai/v1',
      priority: 1,
    ...
    },
    {
      ...
      name: 'NVIDIA Build Conversational Examiner (Nemotron 70B Dialogue)',
      type: 'CLOUD',
      modelId: 'nvidia/llama-3.1-nemotron-70b-instruct',
      baseUrl: 'https://integrate.api.nvidia.com/v1',
      priority: 1,
    ...
    {
      id: 'prov_ivconv_allam',
      name: 'ALLaM AI Multilingual Oral Examiner (allam-7b)',
      type: 'CLOUD',
      modelId: 'allam-7b',
    ...
    {
      id: 'prov_ivconv_cloud_gemini',
      name: 'Google Gemini Flash Dialogue Agent (gemini-1.5-flash)',
      type: 'CLOUD',
      modelId: 'gemini-1.5-flash',
      baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
      priority: 2,
    ...
    {
      id: 'prov_ivconv_cloud_openrouter',
      name: 'OpenRouter Free Oral Examiner (Llama 3.3 70B)',
      type: 'CLOUD',
      modelId: 'meta-llama/llama-3.3-70b-instruct:free',
      baseUrl: 'https://openrouter.ai/api/v1',
      priority: 3,
    ...
    {
      id: 'prov_ivconv_cloud_openai',
      name: 'OpenAI GPT-4o Mini Examiner',
      type: 'CLOUD',
      modelId: 'gpt-4o-mini',
      baseUrl: 'https://api.openai.com/v1',
      priority: 4,
    ...
    {
      id: 'prov_ivconv_local_01',
      name: 'Local Ollama Gemma Dialogue (gemma4:e2b)',
      type: 'LOCAL',
      modelId: 'gemma4:e2b',
      baseUrl: 'http://localhost:11434',
      priority: 10,
    ...
    {
      id: 'prov_ivconv_mock_01',
      name: 'Deterministic Oral Examiner Mock Engine',
      type: 'MOCK',
      modelId: 'mock-ivconv-v1',
      baseUrl: 'http://localhost:4043/internal/ai/mock-ivconv',
      priority: 999,
      scope: 'interview_conversation',
      isActive: true,
    },

    // Scope 4: interview_grading (One-shot thorough rubric & scorecard evaluation)
    {
      id: 'prov_ivgrade_cloud_nvidia',
      name: 'NVIDIA Build Nemotron Rubric Evaluator (Nemotron 70B Reasoning)',
      type: 'CLOUD',
      modelId: 'nvidia/llama-3.1-nemotron-70b-instruct',
      baseUrl: 'https://integrate.api.nvidia.com/v1',
      priority: 1,
    ...
    {
      id: 'prov_ivgrade_cloud_groq',
      name: 'Groq Cloud Rubric Evaluator (Llama 3.3 70B)',
      type: 'CLOUD',
      modelId: 'llama-3.3-70b-versatile',
      baseUrl: 'https://api.groq.com/openai/v1',
      priority: 1,
    ...
    {
      id: 'prov_ivgrade_cloud_gemini',
      name: 'Google Gemini Flash Rubric Grader (gemini-1.5-flash)',
      type: 'CLOUD',
      modelId: 'gemini-1.5-flash',
      baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
      priority: 2,
    ...
    {
      id: 'prov_ivgrade_cloud_openai',
      name: 'OpenAI Cloud Rubric Evaluator (GPT-4o Mini)',
      type: 'CLOUD',
      modelId: 'gpt-4o-mini',
      baseUrl: 'https://api.openai.com/v1',
      priority: 3,
    ...
    {
      id: 'prov_ivgrade_cloud_openrouter',
      name: 'OpenRouter Free Rubric Grader (Llama 3.3 70B Free)',
      type: 'CLOUD',
      modelId: 'meta-llama/llama-3.3-70b-instruct:free',
      baseUrl: 'https://openrouter.ai/api/v1',
      priority: 4,
    ...
    {
      id: 'prov_ivgrade_local_01',
      name: 'Local Ollama Gemma Evaluator (gemma4:e2b)',
      type: 'LOCAL',
      modelId: 'gemma4:e2b',
      baseUrl: 'http://localhost:11434',
      priority: 10,
    ...
    {
      id: 'prov_ivgrade_mock_01',
      name: 'Deterministic Rubric Evaluator Mock Engine',
      type: 'MOCK',
      modelId: 'mock-ivgrade-v1',
      baseUrl: 'http://localhost:4043/internal/ai/mock-ivgrade',
      priority: 999,
      scope: 'interview_grading',
      isActive: true,
    },

    // Scope 5: writing_analysis (Essay scoring, grammar & cohesion breakdown)
    {
      id: 'prov_writing_cloud_nvidia',
      name: 'NVIDIA Build Nemotron Essay & Writing Analyst (Nemotron 70B)',
      type: 'CLOUD',
      modelId: 'nvidia/llama-3.1-nemotron-70b-instruct',
      baseUrl: 'https://integrate.api.nvidia.com/v1',
      priority: 1,
    ...
    {
      id: 'prov_writing_cloud_groq',
      name: 'Groq Cloud Writing Rubric Scorer (Llama 3.3 70B)',
      type: 'CLOUD',
      modelId: 'llama-3.3-70b-versatile',
      baseUrl: 'https://api.groq.com/openai/v1',
      priority: 1,
    ...
    {
      id: 'prov_writing_cloud_gemini',
      name: 'Google Gemini Flash Writing Grader (gemini-1.5-flash)',
      type: 'CLOUD',
      modelId: 'gemini-1.5-flash',
      baseUrl: 'https://generativelanguage.googleapis.com/v1beta/openai',
      priority: 2,
    ...
    {
      id: 'prov_writing_cloud_openai',
      name: 'OpenAI Essay Evaluator (GPT-4o Mini)',
      type: 'CLOUD',
      modelId: 'gpt-4o-mini',
      baseUrl: 'https://api.openai.com/v1',
      priority: 3,
    ...
    {
      id: 'prov_writing_cloud_openrouter',
      name: 'OpenRouter Free Writing Assessor (Llama 3.3 70B Free)',
      type: 'CLOUD',
      modelId: 'meta-llama/llama-3.3-70b-instruct:free',
      baseUrl: 'https://openrouter.ai/api/v1',
      priority: 4,
    ...
    },
    {
      ...
      name: 'Deterministic Writing Analysis Mock Engine',
      type: 'MOCK',
      modelId: 'mock-writing-v1',
      baseUrl: 'http://localhost:4043/internal/ai/mock-writing',
      priority: 999,
      scope: 'writing_analysis',
      isActive: true,
    },
  ...
  const defaultTemplates = [
    ...
    },
    {
      ...
      version: 1,
      dailyLimit: 50,
      systemPrompt: 'You are an expert oral examination examiner conducting an interactive, natural multi-turn interview dialogue.',
      userPromptTemplate: 'Examine candidate on topic: "{topic}". Candidate response: "{candidateResponse}".',
      expectedSchema: JSON.stringify({
        type: 'object',
        properties: {
          content: { type: 'string' },
    ...
    },
    {
      ...
      version: 1,
      dailyLimit: 25,
      systemPrompt: 'You are a certified rubric examiner evaluating an oral interview transcript across multi-criterion scoring dimensions.',
      userPromptTemplate: 'Evaluate interview transcript for candidate. Question: "{questionContent}". Rubric: {rubric}.',
      expectedSchema: JSON.stringify({
        type: 'object',
        properties: {
          ...
          rubricScores: { type: 'array' },
          feedback: { type: 'string' },
          strengths: { type: 'array' },
          weaknesses: { type: 'array' },
          recommendations: { type: 'array' },
        },
        required: ['finalScore', 'maxScore', 'rubricScores', 'feedback'],
      }),
    },
    {
      id: 'tmpl_writing_01',
      ...
      version: 1,
      dailyLimit: 25,
      systemPrompt: 'You are an academic writing and essay assessor evaluating student writing across Task Achievement, Coherence & Cohesion, Lexical Resource, and Grammatical Accuracy.',
      userPromptTemplate: 'Evaluate student essay for prompt: "{writingPrompt}". Student essay text: "{studentText}".',
      expectedSchema: JSON.stringify({
        type: 'object',
        properties: {
          finalScore: { type: 'number' },
        ...
        required: ['finalScore', 'maxScore', 'criteria', 'feedback'],
      }),
    },
    {
